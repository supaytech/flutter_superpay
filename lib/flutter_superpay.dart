...
class FlutterSuperpay {
  ...
  static Future<SuperPayResult> pay(String payInfo, String channel) async {
    final Map<String, dynamic> params = <String, dynamic>{
      'payInfo': payInfo,
      'channel': channel, // 微信:wx  支付宝:alipay
    };
    var res = await _channel.invokeMethod('pay', params);
    return new SuperPayResult(result: res['result'],resultStatus: res['resultStatus'],memo: res['mono']);
  }
}
